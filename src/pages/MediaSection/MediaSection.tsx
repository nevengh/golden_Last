...
const MediaSection: React.FC = () => {
  ...
  const [currentCategory, setCurrentCategory] =
    useState<keyof VideoCategories>("behindTheScene"); // Default category is 'behindTheScene'
  ...
  return (
    <div className="MediaSection">
      ...
      <div className="filter_btns">
        <button onClick={() => setCurrentCategory("behindTheScene")}>
          Behind The Scene
        </button>
        <button onClick={() => setCurrentCategory("corporateVideos")}>
          Corporate Videos
        </button>
        <button onClick={() => setCurrentCategory("marketingVideos")}>
          Marketing Videos
        </button>
        <button onClick={() => setCurrentCategory("educationalVideos")}>
          Educational Videos
        </button>
        <button onClick={() => setCurrentCategory("userGenerated")}>
